...
static void change_fps(sfEvent event,
    state_info_t *state, setting_t *setting)
{
...
static void change_volume(sfEvent event,
    state_info_t *state, setting_t *setting)
{
...
static void change_window(system_t *sys,
    sfRenderWindow *new, sfBool old, state_info_t *state)
{
    if (new != NULL) {
...
static void switch_screen(sfEvent event,
    system_t *sys, setting_t *settings, state_info_t *state)
{
