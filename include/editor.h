...
static const button_t BUTTON[] __maybe_unused = {
    ...
    [EDIT_SMALL_HEALTH] = {(sfVector2f){1600, 550}, "small health", STAY},
    [EDIT_BIG_HEALTH] = {(sfVector2f){1750, 550}, "big health", STAY},
    [EDIT_STAMINA] = {(sfVector2f){1600, 640}, "staminat", STAY},
    [EDIT_FLASHLIGHT] = {(sfVector2f){1750, 640}, "flashlight", STAY},
    [EDIT_AMMO_PISTOL] = {(sfVector2f){1600, 730}, "ammo pistol", STAY},
    [EDIT_WEAPON_TWO] = {(sfVector2f){1750, 730}, "pistol", STAY},
    [EDIT_AMMO_SHUTGUN] = {(sfVector2f){1600, 820}, "ammo shutgun", STAY},
    [EDIT_WEAPON_THREE] = {(sfVector2f){1750, 820}, "shutgun", STAY},
    [EDIT_AMMO_MINIGUN] = {(sfVector2f){1600, 910}, "ammo minigun", STAY},
    [EDIT_WEAPON_FOUR] = {(sfVector2f){1750, 910}, "minigun", STAY},
    [EDIT_AMMO_PLASMA] = {(sfVector2f){1600, 1000}, "ammo plama", STAY},
    [EDIT_WEAPON_FIVE] = {(sfVector2f){1750, 1000}, "plasmagun", STAY},
    [EDIT_SWORD_ENEMY] = {(sfVector2f){1600, 160}, "sword", STAY},
    [EDIT_GUN_ENEMY] = {(sfVector2f){1750, 160}, "gun", STAY},
    [EDIT_SHEET_ENEMY] = {(sfVector2f){-1750, -250}, "cyborg", STAY},
    [EDIT_CYBORG] = {(sfVector2f){1750, 250}, "cyborg", STAY},
    [EDIT_GROWLER] = {(sfVector2f){1600, 250}, "growler", STAY},
    [EDIT_PHANTOM] = {(sfVector2f){1750, 340}, "phantom", STAY},
    [EDIT_BOSS] = {(sfVector2f){1600, 340}, "boss", STAY},
